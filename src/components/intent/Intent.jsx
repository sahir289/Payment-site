...
const Intent = ({ ac_name, ac_no, bank_name, ifsc, amount, name, setStatus, ...props}) => {
            ...
            <Modal open={open} closable={false} footer={null} centered>
                <Form onFinish={processPayment} layout='vertical'>
                    ...
                    <div className='flex justify-end'>
                        <Button type='primary' className='!bg-[#000000]' htmlType='submit'>
                            Proceed
                        </Button>
                    </div>
                </Form>
            ...
            <div className="section-container">
                ...
                <div className="intent-details-section" style={{ height: "100px" }}>
                    <Button
                        ...
                        className='text-xl'
                        onClick={()=>handleIntentPay(types.G_PAY)}
                    ...
                    <Button 
                        ...
                        onClick={()=>handleIntentPay(types.PHONE_PE)}
                ...
                <div className="intent-details-section mt-5" style={{ height: "100px" }}>
                    <Button 
                        style={{ height: "60px", backgroundColor: "rgb(250, 250, 242)", border: "none" }} 
                        className='text-xl'
                        onClick={()=>handleIntentPay(types.PAY_TM)}
                    ...
                    <Button 
                        className='ml-3 text-xl' 
                        style={{ height: "60px", backgroundColor: "rgb(250, 250, 242)", border: "none" }}
                        onClick={()=>handleIntentPay(types.BHIM)}
