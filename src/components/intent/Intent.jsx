...
const Intent = ({ ac_name, ac_no, bank_name, ifsc, amount, paymentURL, id }) => {
        ...
        <section>
            ...
            <div className="section-container">
                ...
                <div className="intent-details-section" style={{height:"100px"}}>
                    <Button style={{height:"60px",backgroundColor:"rgb(250, 250, 242)",border:"none"}} className='text-xl' onClick={() => handleIntentUPIPayment(paymentURL.gpay)}>
                    ...
                    <Button className='ml-3 text-xl' style={{height:"60px",backgroundColor:"rgb(250, 250, 242)",border:"none"}} onClick={() => handleIntentUPIPayment(paymentURL.phonepe)}>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                ...
                <div className="intent-details-section mt-5" style={{height:"100px"}}>
                    <Button style={{height:"60px",backgroundColor:"rgb(250, 250, 242)",border:"none"}} className='text-xl' onClick={() => handleIntentUPIPayment(paymentURL.paytm)}>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                    ...
                    <Button className='ml-3 text-xl' style={{height:"60px",backgroundColor:"rgb(250, 250, 242)",border:"none"}} onClick={() => handleIntentUPIPayment(paymentURL.bhim)}>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
