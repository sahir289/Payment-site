...
const Intent = ({ ac_name, ac_no, bank_name, ifsc, amount, name, }) => {
    return (
        <section>
            ...
            <div className="section-container">
                ...
                <Divider />
                <div className="details-section" style={{height:"100px"}}>
                    <Button style={{height:"60px",backgroundColor:"rgb(250, 250, 242)",border:"none"}} className='text-xl'>
                    ...
                    <Button className='ml-3 text-xl' style={{height:"60px",backgroundColor:"rgb(250, 250, 242)",border:"none"}}>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                ...
                <div className="details-section mt-5" style={{height:"100px"}}>
                    <Button style={{height:"60px",backgroundColor:"rgb(250, 250, 242)",border:"none"}} className='text-xl'>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
